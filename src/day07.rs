...
impl Hand {
    ...
    fn cmp_part1(&self, other: &Self) -> Ordering {
        ...
        self.cards
            ...
            .map(|(c0, c1)| c0.value_part1().cmp(&c1.value_part1()))
    ...
    fn cmp_part2(&self, other: &Self) -> Ordering {
        ...
        self.cards
            .iter()
            .zip(other.cards.iter())
            .map(|(c0, c1)| c0.value_part2().cmp(&c1.value_part2()))
            .find(|ord| *ord != Ordering::Equal)
            .unwrap()
    }
}
